...
const filterPopularDish = (category: string) => {
    ...
    return (
      <div className="row">
        <ul className="nav nav-tabs menu_tab row" id="myTab" role="tablist">
          ...
          <li className="nav-item col-3">
            <a className="nav-link" id="chicken-tab" data-bs-toggle="tab" href="#spaghetti" role="tab"
              onClick={() => handleTabClick('chicken')} >Gà rán</a>
          </li>
          <li className="nav-item col-3">
  ...
  /*Popular dish list*/
//   const listPopularDish = filterPopularDish.map(dish => {
//     const { name, image, price, description, id } = dish
//     return (
//       <ProductItem
//         productName={name}
//         productImage={image}
