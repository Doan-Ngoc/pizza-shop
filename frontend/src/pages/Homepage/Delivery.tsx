...
const Delivery: React.FC = () => {
  return (
    <div
      className="delivery-container w-100"
      style={{ backgroundImage: "url('images/homepage/wave-background.png')" }}
    >
      <div className="delivery d-flex">
        <img
          className="delivery-img img-fluid"
          src="images/homepage/delivery.png"
        />
        <div className="delivery-text">
          <h2 className="title">
            Giao hàng tận nơi, <br /> đặt là tới liền
          </h2>
